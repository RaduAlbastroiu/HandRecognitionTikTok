    ...
    train: function (data, labels, options) {
      ...
      while (passes < numpasses && iter < maxiter) {
        ...
        for (var i = 0; i < N; i++) {
          ...
          if (
            (labels[i] * Ei < -tol && this.alpha[i] < C) ||
            ...
            var eta =
              2 * this.kernelResult(i, j) -
              this.kernelResult(i, i) -
            ...
            var b1 =
              this.b -
              Ei -
              labels[i] * (newai - ai) * this.kernelResult(i, i) -
              labels[j] * (newaj - aj) * this.kernelResult(i, j);
            var b2 =
              this.b -
              Ej -
              labels[i] * (newai - ai) * this.kernelResult(i, j) -
